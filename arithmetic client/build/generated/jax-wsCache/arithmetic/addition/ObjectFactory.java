 ...
 * generated in the addition package. 
...
public class ObjectFactory {
    ...
    private final static QName _Addition_QNAME = new QName("http://addition/", "addition");
    private final static QName _AdditionResponse_QNAME = new QName("http://addition/", "additionResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: addition
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://addition/", name = "addition")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://addition/", name = "additionResponse")
